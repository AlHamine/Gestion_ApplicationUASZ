...
public class GestionApplicationUaszApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Deploiement d1 = deploiementService
				.ajoutDeploiement(new Deploiement(null, "google.com", new Date(), null, null));
		...
		for (int i = 0; i < 10; i++) {
			...
			deploiementService.ajoutDeploiement(new Deploiement(null, serveur, dateDeploiement, null, null));
		}
		...
		applicationService.ajoutApplication(new Application(null, "Windows", "11", "Microsoft", "utiliser app mobile",
